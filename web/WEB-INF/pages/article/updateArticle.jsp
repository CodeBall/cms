...
<div class="article">
  <form action="/article/update/${article.articleId}" method="post">
    <div class="left">
      <div class="title">
        <h3>撰写新文章</h3>
        <input type="text" name="articleName" class="form-control" value="${article.articleName}"/>
      </div>
      <div class="content">
        <h3>撰写文章内容</h3>
      ...
      <div class="right_top">
        ...
        <div class="submit_bottom">
          <div class="bottom_left">
            <a href="/article/toDraft/${article.articleId}">移至回收站</a>
          </div>
